-- 011_add_prompt_reference_to_chat_settings.sql
-- 为私聊和群聊设置表增加 prompt 关联，允许自定义 Agent Prompt

ALTER TABLE private_chat_settings
  ADD COLUMN agent_prompt_id VARCHAR(64) NULL COMMENT '指定的 agent_prompt ID，用于自定义私聊 Prompt' AFTER user_notes,
...
ALTER TABLE group_chat_settings
  ADD COLUMN agent_prompt_id VARCHAR(64) NULL COMMENT '指定的 agent_prompt ID，用于自定义群聊 Prompt' AFTER admin_user_id,
