...
const { createAgentTaskPersistence, createXiaoniHelpPersistence } = require('./agent-tasks');
const { createXiaoniDeepDivePersistence } = require('./xiaoni-deep-dive');
const { createXiaoniOsRewritePersistence } = require('./xiaoni-os-rewrite');
...
const recallImportance = require('./xiaoni-recall-importance');
const recallLlmIo = require('./xiaoni-recall-llm-io');
const recallQueryExpansion = require('./xiaoni-recall-query-expansion');
const recallDeliveryJudge = require('./xiaoni-recall-delivery-judge');
...
const xiaoniHelpPersistence = createXiaoniHelpPersistence({ getPrismaClient });

const xiaoniOsRewritePersistence = createXiaoniOsRewritePersistence({
  createSqlAdapter
});
...
const xiaoniActivityPersistence = createXiaoniActivityPersistence({
  ...
  listProviderUsageEvents: xiaoniAgentStackPersistence.listProviderUsageEvents,
...
module.exports = {
  ...
  ...xiaoniHelpPersistence,
  ...xiaoniOsRewritePersistence,
